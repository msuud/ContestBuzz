...
const getPlatformColor = (platform) => {
  const colors = {
    LeetCode: "rgba(255, 160, 0, 0.2)",
    CodeForces: "rgba(0, 100, 200, 0.2)",
    CodeChef: "rgba(100, 60, 20, 0.2)",
    AtCoder: "rgba(255, 255, 255, 0.2)",
    GeeksforGeeks: "rgba(0, 150, 0, 0.2)",
  };

  return colors[platform] || "rgba(30, 41, 59, 0.5)";
};
  ...
  return (
    <GridContainer>
      {platforms.map((platform, index) => (
        ...
        >
          <IconContainer>{getPlatformIcon(platform.name, 40)}</IconContainer>
