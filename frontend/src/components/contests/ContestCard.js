...
const GradientBorderWrapper = styled.div`
  padding: 0.6px;
  border-radius: 16px;
  background: linear-gradient(135deg, #114a0fff, #114a0fff, #114a0fff);
  ...
  return (
    <GradientBorderWrapper>
      <CardContainer
        ...
        backgroundImage={`/assets/${contest.platform.toLowerCase()}.png`}
      >
        <CardHeader>
          <PlatformLogo>{getPlatformIcon(contest.platform, 32)}</PlatformLogo>
